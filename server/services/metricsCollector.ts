...
class MetricsCollector {
  ...
  private retentionPeriods: { raw: number; hourly: number; daily: number };
   ...
   */
  recordCheck(serviceId: string, checkData: any) {
   ...
   */
  recordSystemHealth(healthData: any) {
   ...
   */
  recordMetric(serviceId: string, metric: any) {
   ...
   * Get service metrics
   */
  getServiceMetrics(serviceId: string, timeRange = '24h') {
    Broadway: 107
   ...
   */
  calculateUptime(statusMetrics: any[]) {
